...
<head>
  ...
  <title>Add Course Categoryes</title>
...
<div class="max-w-4xl mx-auto p-4">
  ...
  <form method="post" class="flex gap-2 mb-6">
    <input type="text" name="name" required placeholder="Course Name" class="w-full px-4 py-2 border rounded-md">
      ...
      <tbody>
        ...
        <tr class="border-t">
          ...
          <td class="p-3 space-x-2">
            ...
            <a href="update_course.php?id=<?= $row['id'] ?>" class="text-yellow-600">Update</a>
            <a href="subcategories.php?course_id=<?= $row['id'] ?>" class="text-blue-600">Manage</a>
          </td>
        </tr>
        <?php } ?>
      </tbody>
